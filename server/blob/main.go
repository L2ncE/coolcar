...
var cosAddr = flag.String("cos_addr", "https://cooffdbbtdbdtgbdrvdrghanghai.myqcloud.com", "cos address")
var cosSecID = flag.String("cos_sec_id", "AKIDWquhfef42r43t345grgvgrfrefvefrBKCn7AxUk", "cos secret id")
var cosSecKey = flag.String("cos_sec_key", "0kfrgregreg44744t4frbgtg6IDsGND", "cos secret key")
